...
int main() {
    ...
    auto player = Entity(0, 0, 0, 'X', true, vector < std::unique_ptr<EntityMovement>{std::make_unique<MoveByUser>(MoveByUser(input))});
    ...
    Entity PAKTS = Entity(28, 5, 0, Sprite{ "Press Any Key To Start" });
